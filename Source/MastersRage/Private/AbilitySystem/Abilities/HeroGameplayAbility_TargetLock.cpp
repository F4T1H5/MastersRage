...
void UHeroGameplayAbility_TargetLock::OnTargettLockTick(float DeltaTime)
{
	if (!CurrentLockedActor || 
		UMastersRageFunctionLibrary::NativeDoesActorHaveTag(CurrentLockedActor, MastersRageGameplayTags::Shared_Status_Dead) ||
		UMastersRageFunctionLibrary::NativeDoesActorHaveTag(GetHeroCharacterFromActorInfo(), MastersRageGameplayTags::Shared_Status_Dead)
		)
	{
	...
	const bool bShouldOverrideRotation =
		!UMastersRageFunctionLibrary::NativeDoesActorHaveTag(GetHeroCharacterFromActorInfo(), MastersRageGameplayTags::Player_Status_Rolling)
		&&
		!UMastersRageFunctionLibrary::NativeDoesActorHaveTag(GetHeroCharacterFromActorInfo(), MastersRageGameplayTags::Player_Status_Blocking);
...
void UHeroGameplayAbility_TargetLock::SwitchTarget(const FGameplayTag& InSwitchDirectionTag)
{
	...
	if (InSwitchDirectionTag == MastersRageGameplayTags::Player_Event_SwitchTarget_Left)
	{
...
void UHeroGameplayAbility_TargetLock::DrawTargetLockWidget()
{
	...
	{
		checkf(TargetLockWidgetClass, TEXT("Forgot to assing a valid widget class in BP."));

		DrawnTargetLockWidget = CreateWidget<UMastersRageWidgetBase>(GetHeroControllerFromActorInfo(), TargetLockWidgetClass);
