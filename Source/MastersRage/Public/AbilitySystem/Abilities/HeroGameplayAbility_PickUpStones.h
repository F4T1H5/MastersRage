...
class AMastersRageStoneBase;

/**
 * 
 */
UCLASS()
class MASTERSRAGE_API UHeroGameplayAbility_PickUpStones : public UMRageHeroGameplayAbility
{
	GENERATED_BODY()
...
private:
	...
	UPROPERTY()
	TArray<AMastersRageStoneBase*> CollectedStones;
};
